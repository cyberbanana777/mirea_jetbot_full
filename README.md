...
4. **Запрос коэффициентов PID-регуляторов**
```
$4;#
```
где:
...
3. **Получение коэффициентов PID-регуляторов:**
    Если отправить сообщение-команду типа 4 с Jetson на ESP32, то коэффициенты регуляторов на ESP32 будут отправлены в ответ в виде сообщения-ответа типа 2 с Jetson на ESP32.
